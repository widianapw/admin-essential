                ...
                <form action="/keuangan/{{$keuangan->id}}" method="POST" class="form-group">
                    ...
                    <div class="form-body">
                        ...
                        <select name="jenis" class="form-control" required>
                            ...
                            <option value="pendapatan" @if ($keuangan->jenis == "pendapatan") selected @endif>Pendapatan</option>
                            <option value="pengeluaran" @if ($keuangan->jenis == "pengeluaran") selected @endif >Pengeluaran</option>
                        </select>
